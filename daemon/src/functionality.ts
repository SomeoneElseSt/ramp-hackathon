// functionality.ts — label discovered network sources as listenable capabilities.
// Mirrors har-recorder/src/core/functionality.js so the daemon can grow the
// catalog without importing the extension.
